...
1. Clone the nexus repository:
        ...
        git clone git@github.com:valleedelisle/nexus.git
...
4. Edit your files and validate with tox:
    ...
    2. In this way, errors that might be relevant to the test environment can be skipped.
...
5. Update your local repository:
        ...
        For the message, please use a short line with the fix and the subject like `[feature] report sosreport perf data`
...
You can see pending and already merged actual changes at: <https://review.gerrithub.io/#/q/project:valleedelisle/nexus>
